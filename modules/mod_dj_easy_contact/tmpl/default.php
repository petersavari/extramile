...
$dj_mobileno = $input->post->getString('dj_mobileno');
...
if(isset($_POST['dj-easy-contact-send-' . $moduleId])) {
  ...
  if($dj_email){
	...
	$message_text = JText::_('MOD_DJ_EASYCONTACT_MESSAGE_INFO'). ' ' . $dj_name.' - '.$dj_email .'-'.$dj_mobileno."\n\n". $dj_message."\n\n".$current_url."\n\n".$user_ip
			...
			<div class="dj-simple-contact-form style-<?php echo $style_file.' '.$mod_class_suffix.' '.$is_email_field_on.' badge-'.$invisible_captcha_badge_class; ?>">
				...
				<form class="easy-contact-form form-validate <?php echo $antispam_class; ?>" id="dj-easy-contact-form-<?php echo $moduleId; ?>" action="<?php echo JFactory::getURI(); ?>" method="post">
					...
					if($style_file != '5'){
						...
						$placeholder_mobileno = "placeholder='".JText::_('MOD_DJ_EASYCONTACT_MOBILENO_LABEL')."'";
					...
					<div class="dj-simple-contact-form">
						...
						<div class="dj-simple-contact-form-row mobileno">

							<input <?php echo $placeholder_mobileno; ?> maxlength="10" class="dj-simple-contact-form inputbox required <?php echo $mod_class_suffix; ?>" type="text" name="dj_mobileno" id="dj_mobileno-<?php echo $moduleId; ?>" value="<?php echo $valid_mobileno; ?>" required="required" />
