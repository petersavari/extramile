		...
		while($i < 23) :
			...
			if( $params->get('fade_text_on_scroll') == 'fade-text-on-scroll' ) {
				...
				if ( ($params->get('transparency_bg_text') == '0' || $params->get('bg_text'.$i) == 'transparent') && $text_shadow == 'no' ) {
					$fadeText ="data-100-top='text-shadow: 0px 0px 0px rgba(0,0,0,1);-webkit-transform: translateY(0px) rotateX(0deg);-ms-transform: translateY(0px) rotateX(0deg);transform: translateY(0px) rotateX(0deg);opacity:1;' data--180-top='text-shadow: 55px 70px 8px rgba(0, 0, 0, 1);-webkit-transform: translateY(-60px) rotateX(20deg);-ms-transform: translateY(-60px) rotateX(20deg);transform: translateY(-60px) rotateX(20deg);opacity:0;' data-anchor-target='#flexslider-".$module_id."'" ;
					} else if ( ($params->get('transparency_bg_text') == '0' || $params->get('bg_text'.$i) == 'transparent') && $text_shadow == 'light' ) {
					$fadeText ="data-100-top='text-shadow: 1px 1px 3px rgba(0,0,0,0.4);-webkit-transform: translateY(0px) rotateX(0deg);-ms-transform: translateY(0px) rotateX(0deg);transform: translateY(0px) rotateX(0deg);opacity:1;' data--180-top='text-shadow: 55px 70px 8px rgba(0, 0, 0, 1);-webkit-transform: translateY(-60px) rotateX(20deg);-ms-transform: translateY(-60px) rotateX(20deg);transform: translateY(-60px) rotateX(20deg);opacity:0;' data-anchor-target='#flexslider-".$module_id."'" ;
					} else if ( ($params->get('transparency_bg_text') == '0' || $params->get('bg_text'.$i) == 'transparent') && $text_shadow == 'dark' ) {
					$fadeText ="data-100-top='text-shadow: 2px 2px 5px rgba(0,0,0,0.8);-webkit-transform: translateY(0px) rotateX(0deg);-ms-transform: translateY(0px) rotateX(0deg);transform: translateY(0px) rotateX(0deg);opacity:1;' data--180-top='text-shadow: 55px 70px 8px rgba(0, 0, 0, 1);-webkit-transform: translateY(-60px) rotateX(20deg);-ms-transform: translateY(-60px) rotateX(20deg);transform: translateY(-60px) rotateX(20deg);opacity:0;' data-anchor-target='#flexslider-".$module_id."'" ;
					} else {
					$fadeText ="data-100-top='box-shadow: 0px 0px 0px 0px rgba(0,0,0,1);-webkit-transform: translateY(0px) rotateX(0deg);-ms-transform: translateY(0px) rotateX(0deg);transform: translateY(0px) rotateX(0deg);opacity:1;' data--180-top='box-shadow: 40px 50px 15px 5px rgba(0,0,0,1);-webkit-transform: translateY(-60px) rotateX(20deg);-ms-transform: translateY(-60px) rotateX(20deg);transform: translateY(-60px) rotateX(20deg);opacity:0;' data-anchor-target='#flexslider-".$module_id."'" ;
					}
			} else { $fadeText = "";}
